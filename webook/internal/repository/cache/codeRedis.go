...
func NewCodeRedis(c redis.Cmdable) CodeCache {
	return &CodeRedis{client: c}
}

func (cc *CodeRedis) CheckCode(ctx context.Context, key string, input string) error {
...
func (cc *CodeRedis) SetCode(ctx context.Context, key string, val string) error {
	//获取返回值
